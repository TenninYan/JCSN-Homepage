...
<link rel="stylesheet" href="main.css" type="text/css" id="main">
</head>
...
<div class="article" style="height:200px;">
  <h3 class="report-subject">
    <!--リンク先-->
    <a href="newpage31.html" class="report">
      <!--題名-->
      JCSN&nbspプログラム&nbspキックオフミーティング
    </a>
  </h3>
  <h3 class="report-date">
    2014年8月2日
  ...
  <span class="info-photo-right">
    <!--写真-->
    <img src="20140802-2.jpg" width="180" border="0" class="report-round">
  </span>
  <!--内容-->
  <span class="report-text" style="height:120px">
    <p>
      <b><font face="メイリオ">
          ●8/2にJCSN日中大学生×社会人交流プログラムキックオフミーティングが開かれました。<br>
本プログラムは、日中の架け橋となり活躍のできる人材の育成を目的に作られました。このプログラムではケーススタディーや各界で活躍する方との交流を通して、中国への理解を深めることを目的としております。
      </font></b>
      <br>
      <!--リンク先-->
      <a href="newpage31.html">
        ☛詳細レポート 
      </a> 
    </p>
  </span>
...
<div class="article" style="height:200px;">
  <h3 class="report-subject">
    <!--リンク先-->
    <a href="newpage30.html" class="report">
      <!--題名-->
      JCSN　上海・杭州交流会 第三回ミーティング
    </a>
  </h3>
  <h3 class="report-date">
    2014年8月1日
  ...
  <span class="info-photo-left">
    <!--写真-->
    <img src="IMG_20140801_164532.jpg" width="180" border="0" class="report-round">
  </span>
  <!--内容-->
  <span class="report-text" style="height:120px">
    <p>
      <b><font face="メイリオ">
        ●8/1に第３回目の上海・杭州交流会のミーティングが開かれました。<br>
        今回は上海・杭州交流会のシンポジウムでの議題が決まり、グループに分かれてどのような資料を集め、どのような流れで議論するか考えました。
      </font></b>
      <br>
      <!--リンク先-->
      <a href="newpage30.html">
        ☛詳細レポート 
      </a> 
    </p>
  </span>
         ...
         <div class="article"><h3 class="report-subject"><a href="newpage29.html" class="report">JCSN　上海・杭州交流会 第二回勉強会＆OB会交流会</a></h3><h3 class="report-date">2014年7月5日</h3>
        <span class="info-photo-right"><img src="1407139760255.jpg" height="120" border="0" class="report-round"></span>
          <!--内容-->
  <span class="report-text" style="height:120px">
    <p>
      <b><font face="メイリオ">
       ●7月5日に今年の上海・杭州交流会の参加者で集まり、二部制で第一回の勉強会とOB会との交流会が開かれました。勉強会では今年の11月に上海と杭州で視察する企業についてのディスカッション、交流会では去年社会人になられたOBたちとの意見交換が行なわれました。
      </font></b>
      <br>
      <!--リンク先-->
      <a href="newpage29.html">
        ☛詳細レポート 
      </a> 
    </p>
  </span>
        ...
        <div class="article"><h3 class="report-subject"><a href="newpage28.html" class="report">JCSN　上海・杭州交流会　キックオフミーティング</a></h3><h3 class="report-date">2014年6月8日</h3>
        <div class="info-photo"><img src="1402210367576.jpg" height="120" border="0" class="left"class="report"></div>
   <!--内容-->
  <span class="report-text" style="height:120px">
    <p>
      <b><font face="メイリオ">
      ●6/8に上海・杭州交流会の初めてのミーティングが行われ、参加者たちの初めての顔合わせになりました。ミーティングでは今年11月に上海と杭州で行なうシンポジュウムの議題を考えました。
      </font></b>
      <br>
      <!--リンク先-->
      <a href="newpage28.html">
        ☛詳細レポート 
      </a> 
    </p>
  </span>
...
<font face="メイリオ">　台風27号の接近が心配されましたが、無事10月26日(土)にJCSN上海学生交流会事前ミーティングを開催することが出来ました。交流会本番前の最終ミーティングということもあり、参加者の大半が顔を合わせ、当日行われるシンポジウムの論点の詳細等を全体で検討しました。また中国で交流する学生に向けてグループごとビデオメッセージを中国語や英語で撮影し、より緊密な交流が出来るよう自己紹介パンフレットの作成も決まりました。本番に向けて着々と準備が整ってきています！早いもので上海交流会まで残り一か月を切りました。記念すべき第一回目を成功させられるよう参加者全員で準備を頑張っていきます！</font><a href="newpage16.html">☛詳細レポート</a></div>
        ...
        <span style='font-family:"ＭＳ ゴシック";mso-bidi-font-family:
          ...
          「第二回日中台映画交流会」が開催されました<br>
          上映されたのは中国映画「胡同のひまわり」です。</span><span lang="EN-US" style='font-family:"Arial","sans-serif";mso-fareast-font-family:
          "Times New Roman";color:#222222;mso-fareast-language:JA'><o:p></o:p></span><br>
        <span style='font-family:"ＭＳ ゴシック";mso-bidi-font-family:
          "ＭＳ ゴシック";color:#222222;mso-fareast-language:JA'>１回目は恋愛ものでしたが、２回目の今回は親子ものでした。</span><br>
        <span style='font-family:"ＭＳ ゴシック";mso-bidi-font-family:
