    ...
    <div id="hpb-wrapper">
     <!-- page title -->
      <div id="hpb-title" class="hpb-top-image">
        <h2><span class="ja">協力企業</span><span class="en">COORPORATION</span></h2>
      </div>
      <!-- page title end --><!-- main -->      
      <div id="hpb-main">
        <!-- information -->
        <div id="information">
          ...
          <BR>
          ●　　<b><font size="+1">ISI国際学院</font></b>　　　　　　<a href="http://www.isi-ryugaku.com"><font color="#0000ff">http://www.isi-ryugaku.com</font><font color="#0000cc"><span class="f30"></span></font></a> <span class="f30"></span><BR>
          <br>
